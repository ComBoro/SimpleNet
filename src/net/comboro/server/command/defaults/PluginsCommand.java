...
public class PluginsCommand extends DefaultCommand {
    ...
    public PluginsCommand() {
        super("Plugin Utils", "Plugin Managing",
                "plugins load/reload/unload/info <plugin/fileName/all>", "plugins reload all");
    }
            ...
            case "info":
                ...
                if (forAll) {
                    for (int i = 0; i < allPlugins.size(); i++) {
                        Plugin fp = (Plugin) Application.getPluginMap()
                    ...
                    try {
                        Plugin fp = Application.getPluginMap().getPlugin(
                                pluginName);
                        PluginDescription pd = fp.getDescription();
